...
function CompletedTodo() {
    ...
    const pagedData = userTodos?.slice(offset, offset + pageSize).filter((todo) => todo.complete === true);
                        ...
                        <div className="col-md-12 col-xl-10">
                            <div className="card">
                                ...
                                <ul className="nav nav-tabs mb-4 pb-2" id="ex1" role="tablist">
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link" id="ex1-tab-2" data-mdb-toggle="tab" href="/activetodo" role="tab"
                                            aria-controls="ex1-tabs-2" aria-selected="false">Active</a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link active" id="ex1-tab-3" data-mdb-toggle="tab" href="/completedtodo" role="tab"
