...
import "./login.css";
function ForgotPassword({ forgetpassword, error, successMessage, csrfToken, loader }) {
  ...
  const handleSubmit = async (e) => {
    ...
    forgetpassword(forgetpasswordData, csrfToken);
  };
  ...
  return (
    <>
      ...
      <div className="form-container-main center">
        <p className="title">ForgotPassword</p>
