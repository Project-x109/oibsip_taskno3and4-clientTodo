...
function Login({ login, error, csrfToken, successMessage }) {
  ...
  }, [successMessage, csrfToken, dispatch, isLoggedIn, navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await login(loginData, csrfToken);
  ...
  return (
    <>
      ...
      <div className="form-container-main center">
        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          <p className="page-link">
            <span className="page-link-label"><a href="/forgetpassword">Forgot Password?</a></span>
          </p>
        ...
        <p className="sign-up-label">
          ...
          <span className="sign-up-link">
            <a href="/register" className="page-link-label">
              Sign up
            </a>
          </span>
        </p>
