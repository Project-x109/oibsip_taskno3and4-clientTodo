...
function ResetPassword({ ResetPasswordAction, error, successMessage, csrfToken, loader }) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (password !== ConfirmPassword) {
            Swal.fire({
                ...
                text: "Passowrd and Confirm Password Dont Match",
            });
            return;
        }
        if (!lengthRegex.test(password)) {
            Swal.fire({
                ...
                text: "Passowrd Length Should Be Eight",
            });
            return;
        }
        ...
        ResetPasswordAction(ResetpasswordData, csrfToken, token);
    };
    useEffect(() => {
        if (error) {
    ...
    return (
        <>
            ...
            <div className="form-container-main">
                ...
                <p className="sub-title">Let's get started with your account</p>
                ...
                <p className="sign-up-label">
                    ...
                    <span className="sign-up-link">
                        <a href="/" className="page-link-label">
                            Log in
                        </a>
                    </span>
                </p>
